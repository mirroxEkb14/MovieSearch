        ...
        main_recycler.apply {
            ...
            filmsAdapter = FilmListRecyclerAdapter(object : FilmListRecyclerAdapter.OnItemClickListener{
                override fun click(film: Film) {
                    ...
                    val bundle = Bundle() // create the Bundle and put there the object with the film data
                    bundle.putParcelable("film", film) // first argument - the key by which we will search
                    val intent = Intent(this@MainActivity, DetailsActivity::class.java)
                    intent.putExtras(bundle) // attach the Bundle to the Intent
                    startActivity(intent) // launch the activity through the Intent
                }
            })

            adapter = filmsAdapter // assign the Adapter
            layoutManager = LinearLayoutManager(this@MainActivity) // assign the LayoutManager
